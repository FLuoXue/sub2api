...
const (
	...
	AdminComplianceDocumentURLZH  = "https://github.com/" + githubRepo + "/blob/main/" + AdminComplianceDocumentPathZH
	AdminComplianceDocumentURLEN  = "https://github.com/" + githubRepo + "/blob/main/" + AdminComplianceDocumentPathEN
