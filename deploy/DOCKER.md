...
docker run -d \
  ...
  ghcr.io/fluoxue/sub2api:latest
```
...
services:
  sub2api:
    image: ghcr.io/fluoxue/sub2api:latest
    ports:
      - "8080:8080"
    environment:
...
- [GitHub Repository](https://github.com/FLuoXue/sub2api)
- [Documentation](https://github.com/FLuoXue/sub2api#readme)
