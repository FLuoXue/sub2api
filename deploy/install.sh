...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/FLuoXue/sub2api/main/deploy/install.sh | bash
#
...
Documentation=https://github.com/FLuoXue/sub2api
